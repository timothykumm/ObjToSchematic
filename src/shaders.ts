...
import FRAG_BLOCK from '../res/shaders/block_fragment.fs?raw';
import VERT_BLOCK from '../res/shaders/block_vertex.vs?raw';
import FRAG_DEBUG from '../res/shaders/debug_fragment.fs?raw';
import VERT_DEBUG from '../res/shaders/debug_vertex.vs?raw';
import FRAG_TRI_SOLID from '../res/shaders/solid_tri_fragment.fs?raw';
import VERT_TRI_SOLID from '../res/shaders/solid_tri_vertex.vs?raw';
import FRAG_TRI_TEXTURE from '../res/shaders/texture_tri_fragment.fs?raw';
import VERT_TRI_TEXTURE from '../res/shaders/texture_tri_vertex.vs?raw';
import FRAG_VOXEL from '../res/shaders/voxel_fragment.fs?raw';
import VERT_VOXEL from '../res/shaders/voxel_vertex.vs?raw';
